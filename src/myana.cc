...
////////////////////////////////////////////////////////////////////////////////////////////////////
void MyAna::setData(ulong _pid, std::string _name, double _time, double _delay, double _filling, double _flattop, double _fs, std::vector<double> _pulse){
 time = _time;
 pid = _pid;
 name = _name;
 delay = _delay;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void MyAna::write(std::string filename){
