  ...
  double *SP_F, double *SP_P)
{
  ...
  for (i0 = 0; i0 < ixstart; i0++) {
    ...
    unusedU0->data[i0].re = 3.1415926535897931 * c_x;
    unusedU0->data[i0].im = 3.1415926535897931 * b_x;
  }
