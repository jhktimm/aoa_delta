  ...
  *u_mC, double fs, double QL, emxArray_real_T *dw)
{
  ...
  /* end */
  i9 = r5->size[0] * r5->size[1];
  r5->size[0] = (int)varargin_1_idx_0;
  r5->size[1] = 1;
  emxEnsureCapacity_real_T(r5, i9);
  ...
  loop_ub = y_mC->size[0];
  for (i9 = 0; i9 < loop_ub; i9++) {
    b_y_mC->data[i9] = y_mC->data[i9].re * (dVQ->data[i9] - r5->data[i9] *
      u_mC->data[i9].im);
  }

  rdivide(b_y_mC, r6, dVQ);
  i9 = r5->size[0] * r5->size[1];
  r5->size[0] = (int)varargin_1_idx_0;
  r5->size[1] = 1;
  emxEnsureCapacity_real_T(r5, i9);
  ...
  loop_ub = y_mC->size[0];
  for (i9 = 0; i9 < loop_ub; i9++) {
    b_y_mC->data[i9] = y_mC->data[i9].im * (r5->data[i9] * u_mC->data[i9].re -
      dVI->data[i9]);
  }

  emxFree_real_T(&r5);
  emxFree_real_T(&dVI);
  rdivide(b_y_mC, r6, dw2);
  i9 = dw->size[0];
