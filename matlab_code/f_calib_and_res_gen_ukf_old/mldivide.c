                ...
                [4])
{
  ...
  if (A->size[0] == 4) {
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = 4;
    emxEnsureCapacity((emxArray__common *)b_A, i2, sizeof(creal_T));
    minmn = A->size[0] * A->size[1];
    for (i2 = 0; i2 < minmn; i2++) {
    ...
    i2 = b_B->size[0];
    b_B->size[0] = B->size[0];
    emxEnsureCapacity((emxArray__common *)b_B, i2, sizeof(creal_T));
    minmn = B->size[0];
    for (i2 = 0; i2 < minmn; i2++) {
