...
static void main_f_generate_and_eval_residual(void)
{
  ...
  argInit_2x2_real_T(dv7);
  argInit_2x1_real_T(dv8);
  argInit_2x2_real_T(dv9);
  argInit_6x6_real_T(dv10);
  f_generate_and_eval_residual(PA, PP, FA, FP, RA, RP, FS, F0, cal_coeff, dv4,
    dv5, dv6, argInit_real_T(), argInit_real_T(), argInit_real_T(),
    argInit_real_T(), dv7, dv8, dv9, dv10, r_cmplx, s_max);
  emxDestroyArray_real_T(s_max);
  emxDestroyArray_creal_T(r_cmplx);
