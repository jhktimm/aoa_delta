  ...
  double fs, emxArray_real_T *r_2)
{
  ...
  for (i23 = 0; i23 < 4; i23++) {
    for (i24 = 0; i24 < 4; i24++) {
      c_I[i24 + (i23 << 2)] = I[i24 + (i23 << 2)] + 0.5 * A_c[i24 + (i23 << 2)] *
        Ts;
    }
  }
  ...
  for (i = 0; i < 4; i++) {
    for (i23 = 0; i23 < 4; i23++) {
      A_d[i + (i23 << 2)] = 0.0;
      for (i24 = 0; i24 < 4; i24++) {
        A_d[i + (i23 << 2)] += c_I[i + (i24 << 2)] * b_I[i24 + (i23 << 2)];
      }
    }
  ...
  for (i23 = 0; i23 < 4; i23++) {
    ...
    for (i24 = 0; i24 < 4; i24++) {
      s[i23] += A_d[i24 + (i23 << 2)];
      dv3[i23] += b_I[i24 + (i23 << 2)];
      dv4[i23] += A_c[i24 + (i23 << 2)];
      dv5[i23] += I[i24 + (i23 << 2)];
    }
  ...
  emxEnsureCapacity_real_T1(u1, i23);
  loop_ub = u_mC->size[0];
  for (i23 = 0; i23 < loop_ub; i23++) {
  ...
  emxEnsureCapacity_real_T1(x1, i23);
  loop_ub = y_mC->size[0];
  for (i23 = 0; i23 < loop_ub; i23++) {
  ...
  emxEnsureCapacity_real_T1(x2, i23);
  loop_ub = y_mC->size[0];
  for (i23 = 0; i23 < loop_ub; i23++) {
  ...
  emxEnsureCapacity_real_T1(u_dw_stacked1, i);
  ...
  i = x2->size[0];
  x2->size[0] = i24 - i23;
  emxEnsureCapacity_real_T1(x2, i);
  loop_ub = i24 - i23;
  for (i24 = 0; i24 < loop_ub; i24++) {
    x2->data[i24] = (-x1->data[i23 + i24] + x1->data[i24]) + (-Ts * x1->data[i24]
      + tol * u1->data[i24] * w12);
  }
  ...
  loop_ub = i24 - i23;
  for (i24 = 0; i24 < loop_ub; i24++) {
    x2->data[i24] = u_dw_stacked1->data[i23 + i24];
  }
  ...
  for (i23 = 0; i23 < 4; i23++) {
    ...
    dv3[i23] = 0.0;
    for (i24 = 0; i24 < 4; i24++) {
      dv3[i23] += c_I[i24 + (i23 << 2)];
    }

    d0 += dv3[i23] * B_d[i23];
    dv4[i23] = 0.0;
    for (i24 = 0; i24 < 4; i24++) {
      dv4[i23] += A_d[i24 + (i23 << 2)];
    }
    ...
    dv5[i23] = 0.0;
    for (i24 = 0; i24 < 4; i24++) {
      dv5[i23] += z1[i24 + (i23 << 2)];
    }

    d3 += dv5[i23] * B_d[i23];
    dv6[i23] = 0.0;
    for (i24 = 0; i24 < 4; i24++) {
      dv6[i23] += b_z1[i24 + (i23 << 2)];
    }

    d4 += dv6[i23] * B_d[i23];
    dv7[i23] = 0.0;
    for (i24 = 0; i24 < 4; i24++) {
      dv7[i23] += A_d[i24 + (i23 << 2)];
    }
  ...
  conv(x2, v, u1);
  i23 = r_2->size[0];
  emxEnsureCapacity_real_T1(r_2, i23);
  loop_ub = r_2->size[0];
  emxFree_real_T(&x2);
  for (i23 = 0; i23 < loop_ub; i23++) {
