  ...
  double QL_nom, emxArray_real_T *residual1)
{
  ...
  emxEnsureCapacity((emxArray__common *)y_mC, i10, sizeof(creal_T));
  ...
  emxEnsureCapacity((emxArray__common *)u_mC, i10, sizeof(creal_T));
  ...
  emxEnsureCapacity((emxArray__common *)u_mCal, i10, sizeof(creal_T));
  ...
  emxEnsureCapacity((emxArray__common *)residual1, i10, sizeof(double));
  loop_ub = y_mC->size[0];
