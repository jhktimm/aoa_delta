  ...
  *plhs[7])
{
  ...
  f_generate_and_eval_residual(PA, PP, FA, FP, RA, RP, FS, F0, cal_coeff, *tau_m,
    ...
    *MeasNoiseVar, *ProcessVar, s_max, &classis, &strengthis, &QL, &dw_stat,
    &SP_F, &SP_P);
  ...
  plhs[3] = b_emlrt_marshallOut(QL);
  plhs[4] = b_emlrt_marshallOut(dw_stat);
  plhs[5] = b_emlrt_marshallOut(SP_F);
  plhs[6] = b_emlrt_marshallOut(SP_P);
